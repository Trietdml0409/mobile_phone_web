...
import { Space,Button, Checkbox, Form, Input,Select,InputNumber } from 'antd';
...
export default function Payment(){
    ...
    return(
        <>
            <div style={{background:"white",height:"100vh",width:"100vw",display:"flex",flexDirection:"row",flexWrap:"wrap",overflowY: "auto"}} >       
                    <Flex  vertical style={{ flex: 1}}>     
                        <Flex gap={10} style={{paddingLeft:"10px"}}>
                            <p style={{paddingTop:"10px",fontWeight:"bold",fontSize:"30px",color:"black"}}>Webpage.com</p> 
                        </Flex>
                        ...
                        <Flex gap={10} style={{paddingLeft:"10px"}} vertical>
                            ...
                            >
                                ...
                                <Form.Item
                                    ...
                                    { pattern: /^[0-9]{9,11}$/, message: 'The input is not valid phone number!' },
                                    ]}
                                >
                                    {/* Demo only, real usage should wrap as custom component */}
                                    <Space.Compact block>
                                    {prefixSelector}
                                    <Input placeholder="Phone Number" style={{ width: '100%' }} size="large" />
                                    </Space.Compact>
                                </Form.Item>
                                <Form.Item
                                    name="address"
                                ...
                                <p style={{color:"black"}}>
                                    <p style={{fontSize:"20px",color:"royalblue"}}>Payment Method</p>
                                </p>
                                {payment}
                                <Form.Item >
                            ...
                            <Button style={{width:"70%"}} onClick={() => router.push(`/cart`)}>Back to Cart</Button>
